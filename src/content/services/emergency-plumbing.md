...
priority: 9.0
plan_hash: "e2c3239969fb2cd9"
generated_at: "2026-08-18T12:23:44.645507+00:00"
manual_override: false
internal_links: ["/services/", "/contact/", "/service-areas/anaheim-ca/emergency-plumbing/", "/service-areas/chino-ca/emergency-plumbing/", "/service-areas/fullerton-ca/emergency-plumbing/", "/service-areas/norco-ca/emergency-plumbing/", "/service-areas/ontario-ca/emergency-plumbing/", "/service-areas/riverside-ca/emergency-plumbing/", "/service-areas/santa-ana-ca/emergency-plumbing/", "/service-areas/yorba-linda-ca/emergency-plumbing/", "/blog/what-to-do-burst-pipe/"]
breadcrumb: [{"name": "Home", "url": "/"}, {"name": "Services", "url": "/services/"}, {"name": "Emergency Plumbing"}]
faq: [{"question": "Does homeowners insurance cover emergency plumbing repairs?", "answer": "Homeowners insurance typically covers sudden and accidental water damage \u2014 a pipe that bursts without warning, for example \u2014 but generally excludes damage from slow leaks or deferred maintenance that a homeowner knew about. RT Olson Plumbing, Heating and Air Conditioning works with all major insurance carriers and provides the photographs, repair documentation, and written scope that adjusters need to process a claim. Getting that documentation at the time of the repair, before anything is cleaned up or closed in, is critical to a smooth claims process."}, {"question": "What should I do while waiting for the emergency plumber to arrive?", "answer": "Shut off the water supply as close to the failure as possible \u2014 the stop valve under a sink or toilet, or the main shutoff at the meter if you can't isolate it. If the leak is near an electrical panel, outlet, or appliance, don't wade through standing water; turn off the circuit at the breaker first. Move valuables, documents, and electronics off the floor if it's safe to do so, and take your own photos of the damage before anything is moved \u2014 your insurance claim will benefit from that record."}, {"question": "How do I know if my sewer backup is a mainline problem or a fixture-level clog?", "answer": "If only one fixture is backing up \u2014 a single toilet or one sink \u2014 the blockage is usually in the branch line serving that fixture. When multiple fixtures back up at the same time, or when flushing a toilet causes a tub or floor drain to gurgle and fill, the obstruction is almost certainly in the main sewer line downstream of where all those branches converge. A camera inspection confirms the location and nature of the blockage \u2014 root intrusion, grease accumulation, a collapsed section \u2014 so the repair targets the right spot."}, {"question": "My water heater is making a loud rumbling or popping noise \u2014 is that an emergency?", "answer": "Rumbling and popping during the heating cycle usually means heavy sediment has built up on the tank floor, forcing the burner to heat water through a layer of mineral scale. It's not immediately dangerous, but it signals that the tank is working harder than it should, efficiency has dropped, and the tank floor is under thermal stress that shortens its remaining life. If the noise is accompanied by water pooling around the base, a dripping T&P relief valve, or discolored hot water, treat it as urgent \u2014 those are signs the tank may be close to failure."}, {"question": "What's the difference between a pinhole leak and a slab leak, and why does it matter for the repair?", "answer": "A pinhole leak is a small perforation in a copper line, typically caused by corrosion from aggressive water chemistry or pitting that develops over time; it's usually accessible behind drywall or under a cabinet and can often be repaired by cutting out the affected section. A slab leak is a failure in a supply or drain line that runs beneath the concrete foundation \u2014 the leak itself may be invisible at the surface, but you might notice a warm spot on the floor, unexplained increases in your water bill, or the sound of running water when everything is off. Slab leaks require detection equipment (acoustic or thermal) to locate precisely, and the repair options \u2014 spot excavation, epoxy lining, or a full reroute above the slab \u2014 depend on the pipe material, the location, and how much of the line is affected."}]

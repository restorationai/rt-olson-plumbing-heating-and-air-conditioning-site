...
title: "Furnace Repair in Corona | RT Olson Plumbing, Heating and Air Conditioning"
h1: "Furnace Repair in Corona"
meta_description: "Trusted furnace repair in Corona and surrounding areas. Licensed and insured plumbing and HVAC pros, upfront pricing, free estimates. Call (951) 344-5596."
primary_keyword: "furnace repair corona"
...
priority: 8.1
plan_hash: "2533986d671fe2c8"
generated_at: "2026-08-18T12:20:20.530117+00:00"
manual_override: false
internal_links: ["/services/", "/contact/", "/service-areas/anaheim-ca/furnace-repair/", "/service-areas/chino-ca/furnace-repair/", "/service-areas/fullerton-ca/furnace-repair/", "/service-areas/norco-ca/furnace-repair/", "/service-areas/ontario-ca/furnace-repair/", "/service-areas/riverside-ca/furnace-repair/", "/service-areas/santa-ana-ca/furnace-repair/", "/service-areas/yorba-linda-ca/furnace-repair/", "/blog/furnace-repair-or-replace/"]
breadcrumb: [{"name": "Home", "url": "/"}, {"name": "Services", "url": "/services/"}, {"name": "Furnace Repair"}]
faq: [{"question": "My furnace is blowing cold air but the fan is running \u2014 what's usually causing that?", "answer": "A furnace running the blower but producing no heat almost always points to an ignition failure \u2014 either a cracked or failed hot surface igniter, a coated flame sensor that can't confirm the burner lit, or a gas valve that isn't opening. In some cases the limit switch has tripped due to overheating, which shuts off the burners while leaving the fan running to cool the heat exchanger. A technician can read the control board's fault code and trace the cause in a single visit."}, {"question": "Does homeowners insurance cover furnace repair?", "answer": "Standard homeowners insurance typically does not cover furnace repairs that result from normal wear and tear or mechanical breakdown \u2014 those are considered maintenance items. However, if the damage was caused by a sudden and accidental event (a power surge, fire, or covered water loss), your policy may apply. RT Olson Plumbing, Heating and Air Conditioning works with all insurance carriers and can provide the documentation and written scope your adjuster needs to evaluate the claim."}, {"question": "How do I know if my heat exchanger is cracked and whether it's safe to run the furnace?", "answer": "A cracked heat exchanger is not always visible to the naked eye, and a furnace with one should not be operated until it's been properly assessed \u2014 combustion gases including carbon monoxide can enter the supply air stream and circulate through the home. Warning signs include a flickering or lifting flame when the blower starts, a smell of exhaust near supply registers, or carbon monoxide detector alerts that coincide with furnace operation. A proper inspection uses combustion gas analysis at the registers under operating conditions, not just a visual check through the burner compartment."}, {"question": "My furnace starts, runs for a few minutes, then shuts off and repeats \u2014 what does that mean?", "answer": "That pattern is called short-cycling, and it usually means the furnace is overheating and tripping the high-limit switch as a safety response. The most common causes are a dirty or clogged air filter restricting return airflow, blocked supply registers, or a failing blower motor that isn't moving enough air across the heat exchanger. Less commonly, an oversized furnace or a failing limit switch itself can produce the same behavior. Running a furnace in this condition stresses the heat exchanger and accelerates cracking, so it's worth diagnosing promptly rather than resetting and waiting."}, {"question": "Can a furnace repair be completed in one visit, or should I expect to be without heat for multiple days?", "answer": "Most common repairs \u2014 flame sensor replacement, igniter swap, capacitor, and many control board replacements \u2014 can be completed in a single visit if parts are on the truck. Motors, OEM-specific control boards, and heat exchangers occasionally require a return trip for parts, though RT Olson carries a broad inventory to minimize that. When a same-day repair isn't possible, a technician can advise on safe temporary heating options and give you a realistic parts timeline before leaving."}]
...
Repair timelines depend on parts availability. Many igniter, sensor, and control board replacements can be completed same-visit. Motors, heat exchangers, and some OEM control boards may require a return trip if parts aren't on the truck.

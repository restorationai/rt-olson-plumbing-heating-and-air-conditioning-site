...
title: "Indoor Air Quality Services in Corona | RT Olson Plumbing, Heating and Air Conditioning"
h1: "Indoor Air Quality Services in Corona"
meta_description: "Trusted indoor air quality services in Corona and surrounding areas. Licensed and insured plumbing and HVAC pros, upfront pricing, free estimates. Call (951) 344-5596."
primary_keyword: "indoor air quality services corona"
...
priority: 5.4
plan_hash: "8c4277e288be5ac1"
generated_at: "2026-08-18T12:21:27.345092+00:00"
manual_override: false
internal_links: ["/services/", "/contact/", "/service-areas/anaheim-ca/indoor-air-quality/", "/service-areas/chino-ca/indoor-air-quality/", "/service-areas/fullerton-ca/indoor-air-quality/", "/service-areas/norco-ca/indoor-air-quality/", "/service-areas/ontario-ca/indoor-air-quality/", "/service-areas/riverside-ca/indoor-air-quality/", "/service-areas/santa-ana-ca/indoor-air-quality/", "/service-areas/yorba-linda-ca/indoor-air-quality/"]
breadcrumb: [{"name": "Home", "url": "/"}, {"name": "Services", "url": "/services/"}, {"name": "Indoor Air Quality Services"}]
faq: [{"question": "Does homeowners insurance cover indoor air quality services?", "answer": "Standard homeowners insurance does not cover elective IAQ upgrades like humidifier installation or filtration improvements. However, if IAQ equipment is being installed as part of a covered loss \u2014 for example, UV treatment following a documented mold remediation after a water claim \u2014 your carrier may include it in the scope depending on your policy language. RT Olson Plumbing, Heating and Air Conditioning works with all insurance carriers and handles the documentation needed to support those line items in a claim."}, {"question": "What is the difference between a UV air purifier for HVAC and a whole house air purifier, and do I need both?", "answer": "A UV-C germicidal lamp targets biological contaminants \u2014 mold, bacteria, and some viruses \u2014 by disrupting their cellular structure at the coil or in the return air stream. A whole house air purifier (electronic or polarized media) targets particulates by giving them an electrostatic charge so they collect on a capture surface rather than recirculating. They address different problems: if your primary concern is biological growth on the coil or airborne pathogens, UV is the right tool; if you are dealing with fine dust, pet dander, or wildfire smoke particulates, a purifier or high-MERV media cabinet is more effective. Many homes benefit from both, but a diagnostic assessment will tell you which problem is actually driving your symptoms."}, {"question": "Will upgrading to a higher-MERV filter damage my HVAC system?", "answer": "It can, if the filter is not matched to your blower's capacity. Higher-MERV filters are denser and create more resistance to airflow \u2014 a metric called external static pressure. If your air handler was sized for a MERV 6 filter and you install a MERV 13 without checking static pressure, the blower works harder, airflow drops, and in cooling mode you risk coil freeze-up. A proper HVAC filtration upgrade includes a static pressure measurement before and after installation to confirm the system is operating within the manufacturer's design range."}, {"question": "How often do UV lamps and humidifier media pads need to be replaced?", "answer": "UV-C germicidal lamps lose roughly 40% of their output over the course of a year even if they are still glowing, so annual replacement \u2014 typically at the spring tune-up before cooling season \u2014 is the standard maintenance interval. Humidifier media pads (also called evaporator pads or water panels) should be replaced once per heating season; in areas with hard water like the Inland Empire, mineral scale buildup can reduce efficiency significantly by mid-season. Both items are inexpensive relative to the equipment cost and are easy to include in a scheduled maintenance visit."}, {"question": "What does an indoor air quality test actually measure, and how is it different from just looking at my filter?", "answer": "A visual filter inspection tells you what the filter caught \u2014 it says nothing about particle size distribution, what bypassed the filter, biological load in the duct system, humidity levels, or chemical off-gassing from building materials and furnishings. A calibrated IAQ assessment uses a particle counter to measure PM2.5 and PM10 concentrations in the living space, a hygrometer to log relative humidity across rooms, and in some cases a VOC meter to detect chemical contaminants. That data gives you an actual baseline to compare against after equipment is installed, and it often reveals that the problem driving symptoms is not what the homeowner assumed."}]

---
archetype: "blog-post"
title: "7 Warning Signs of a Slab Leak (and What To Do About Them)"
h1: "7 Warning Signs of a Slab Leak (and What To Do About Them)"
meta_description: ""
primary_keyword: "7 warning signs of a slab leak and what to do about them"
secondary_keywords: ["slab leak repair", "leak detection"]
search_intent: "informational_symptom"
priority: 4.8
plan_hash: "4488f12e14e9f701"
generated_at: "2026-08-18T12:33:29.380553+00:00"
manual_override: false
internal_links: ["/blog/", "/services/leak-detection/", "/blog/low-water-pressure-causes/"]
breadcrumb: [{"name": "Home", "url": "/"}, {"name": "Blog", "url": "/blog/"}, {"name": "7 Warning Signs of a Slab Leak (and What To Do About Them)"}]
faq: [{"question": "How much does slab leak repair typically cost?", "answer": "Cost varies significantly based on where the leak is located, what repair method is used, and whether any flooring or drywall needs to be restored afterward. A spot repair through direct slab access is generally less expensive than a full pipe reroute, but the right method can only be determined after a proper leak detection assessment. Getting a written estimate before any work begins is standard practice."}, {"question": "Does homeowner's insurance cover slab leaks?", "answer": "Many standard homeowner's policies cover the resulting damage \u2014 warped flooring, mold remediation, drywall \u2014 but not the cost of repairing the pipe itself. Coverage for the access work (breaking and patching the slab) varies by policy and insurer. Review your policy's 'service line' and 'sudden and accidental discharge' language, and document everything before repairs begin so you have a clear record for your adjuster."}, {"question": "Can a slab leak cause foundation damage?", "answer": "Yes. Sustained water intrusion beneath a slab erodes and shifts the soil that supports the foundation. Over time this can cause differential settling \u2014 where one section of the slab sinks or tilts relative to another \u2014 which produces the floor cracks and sticking doors often attributed to 'normal settling.' Catching the leak early significantly reduces the risk of structural consequences."}, {"question": "How do plumbers find a slab leak without tearing up the floor?", "answer": "Licensed plumbers use electronic acoustic equipment that listens for the distinct sound of pressurized water escaping through a crack in the pipe. They also use pressure isolation testing to narrow down which section of the line is losing pressure. Together, these methods can locate a leak within a few inches, so the slab only needs to be opened at the precise spot \u2014 not across a wide search area."}]
...
If a section of carpet feels damp or spongy underfoot and there's no plumbing fixture directly above it, the moisture is likely wicking up through the slab. In Corona's dry climate, carpets don't stay damp from humidity alone. Press a dry paper towel firmly into the carpet pile. If it comes up with visible moisture, the source is below, not above.
...
If you recognize two or more of these signs, take these steps before calling for help:

1. **Locate your main shutoff valve.** In most Corona homes it's near the front of the property, close to the street-side meter box, or on an exterior wall near the garage. Turn it clockwise until it stops.
2. **Do the meter test.** Before shutting off, note your meter reading. After shutting off all interior valves, check again in 15 minutes. Movement confirms an active leak somewhere in the system.
3. **Document what you're seeing.** Take photos or short videos of damp carpet, warm floor spots, cracks, or stains. This record is useful for both the plumber and your homeowner's insurance claim.
4. **Don't run water unnecessarily.** Every gallon you push through the system while the line is compromised adds pressure to the break and more water to the soil beneath your slab.
5. **Move valuables off affected flooring.** Moisture wicking through a slab can spread laterally. Rugs, furniture, and stored items near the damp zone are at risk.
